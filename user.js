...
getPlayerCards =username=> require('async-get-json')(`https://api2.splinterlands.com/cards/collection/${username}`)
  .then(({cards}) => [...basicCards(cards.map(c=>c.card_detail_id)),...cards.filter(o => !(o.market_id && o.market_listing_status === 0) && (!o.delegated_to || o.delegated_to === username))
